...
ntão, utilize um laço for para exibir o nome de cada animal.
...
têm em comum. Você poderia exibir uma frase como Qualquer um desses animai
seria um ótimo animal de estimação!
"""

animais = ['gaviao', 'arara', 'papagaio']
for a in animais:
    print(f"Um {a} seria um ótimo animal de estimação")
